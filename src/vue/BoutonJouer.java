...
public class BoutonJouer extends JButton implements MouseListener {
	...
	private static BoutonJouer Instance= null;
	
	public void init(){
       this.background = ResourceLoader.getImage("boutons/Jouer.png");
       this.background_hover = ResourceLoader.getImage("boutons/Jouer_.png");
